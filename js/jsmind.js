...
! function (e, t) {
                ...
                request: function (e, t, i, n, o) {
                    ...
                    r && (r.onreadystatechange = function () {
                        if (4 == r.readyState)
                            ...
                            } else "function" == typeof o ? o(r) : a.error("xhr request failed.", r)
                    }, i = i || "GET", r.open(i, e, !0), r.setRequestHeader("If-Modified-Since", "0"), "POST" == i ? (r.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"), r.send(s)) : r.send())
                },
                get: function (e, t) {
    ...
    class h {
        constructor(e, t, i, n, o, s, r, d) {
            e ? "number" == typeof t ? (void 0 === d && (d = !0), this.id = e, this.index = t, this.topic = i, this.data = n || {}, this.isroot = o, this.parent = s, this.direction = r, this.expanded = !!d, this.children = [], this._data = {}) : a.error("invalid node index") : a.error("invalid node id")
        }
        get_location() {
    ...
    class _ {
        ...
        get_node(e) {
            return e in this.nodes ? this.nodes[e] : (a.warn("the node[id=" + e + "] can not be found"), null)
        }
        set_root(e, t, i) {
            return null == this.root ? (this.root = new h(e, 0, t, i, !0), this._put_node(this.root), this.root) : (a.error("root node is already exist"), null)
        }
        add_node(e, t, n, o, s, r, d) {
            if (!h.is_node(e)) return a.error("the parent_node " + e + " is not a node."), null;
            var l = new h(t, d || -1, n, o, !1, e, e.direction, r);
            return e.isroot && (l.direction = s || i.right), this._put_node(l) ? (e.children.push(l), this._update_index(e)) : (a.error("fail, the node id '" + l.id + "' has been already exist."), l = null), l
        }
        insert_node_before(e, t, i, n, o) {
            if (!h.is_node(e)) return a.error("the node_before " + e + " is not a node."), null;
            var s = e.index - .5;
        ...
        get_node_before(e) {
            if (!h.is_node(e)) {
                ...
                return t ? this.get_node_before(t) : (a.error("the node[id=" + e + "] can not be found."), null)
            }
        ...
        insert_node_after(e, t, i, n, o) {
            if (!h.is_node(e)) return a.error("the node_after " + e + " is not a node."), null;
            var s = e.index + .5;
            return this.add_node(e.parent, t, i, n, o, !0, s)
        }
        get_node_after(e) {
            if (!h.is_node(e)) {
                var t = this.get_node(e);
                return t ? this.get_node_after(t) : (a.error("the node[id=" + e + "] can not be found."), null)
            }
            if (e.isroot) return null;
            var i = e.index;
        ...
        move_node(e, t, i, n) {
            return h.is_node(e) ? (i || (i = e.parent.id), this._move_node(e, t, i, n)) : (a.error("the parameter node " + e + " is not a node."), null)
        }
        ...
        _move_node(e, t, n, o) {
            if (e && n) {
                ...
                if (h.inherited(e, s)) return a.error("can not move a node to its children"), null;
                if (e.parent.id != n) {
        ...
        remove_node(e) {
            if (!h.is_node(e)) return a.error("the parameter node " + e + " is not a node."), !1;
            if (e.isroot) return a.error("fail, can not remove root node"), !1;
        ...
        _put_node(e) {
            return e.id in this.nodes ? (a.warn("the node_id '" + e.id + "' has been already exist."), !1) : (this.nodes[e.id] = e, !0)
        }
        _update_index(e) {
            if (e instanceof h) {
    ...
    const u = {
        node_tree: {
            ...
            _extract_subnode: function (e, t, n) {
                ...
                if (n.children)
                    for (var d = n.children, l = 0; l < d.length; l++) o._extract_subnode(e, r, d[l])
            },
            _build_node: function (e) {
                ...
                if (e instanceof h) {
                    ...
                    if (a.length > 0) {
                        n.children = [];
                        for (var r = 0; r < a.length; r++) n.children.push(t._build_node(a[r]))
                    }
                    return n
                }
            }
        ...
        node_array: {
            ...
            _array_node: function (e, t) {
                ...
                if (e instanceof h) {
                    ...
                    t.push(o);
                    for (var r = e.children.length, d = 0; d < r; d++) n._array_node(e.children[d], t)
                }
            }
        },
        freemind: {
            ...
            _load_node: function (e, t, n) {
                ...
                var f = n.childNodes,
                    g = null;
                for (l = 0; l < f.length; l++) 1 == (g = f[l]).nodeType && "node" == g.tagName && o._load_node(e, p, g)
            },
            ...
            _build_map: function (e, t) {
                ...
                var s = e.data;
                if (null != s)
                    for (var a in s) t.push('<attribute NAME="' + a + '" VALUE="' + s[a] + '"/>');
                for (var r = e.children, d = 0; d < r.length; d++) n._build_map(r[d], t);
                t.push("</node>")
            }
        },
        text: {
            ...
            _fill_nodes: function (e, t) {
                ...
                for (; n < t.length;) {
                    let o = t[n],
                        ...
                        a = o.substr(s);
                    if (0 == s && i.length > 0) return void log.error("more than 1 root node was found: " + a);
                    if (s > i.length) return void log.error("a suspended node was found: " + a);
                    let r = i.length - s;
                    for (; r--;) i.pop();
                    if (0 == s && 0 == i.length) {
    ...
    class c {
        ...
        load(e) {
            var t = null,
                i = null;
            return "node_array" == (t = "object" == typeof e ? e.format ? e.format : "node_tree" : "freemind") ? i = u.node_array.get_mind(e) : "node_tree" == t ? i = u.node_tree.get_mind(e) : "freemind" == t ? i = u.freemind.get_mind(e) : "text" == t ? i = u.text.get_mind(e) : a.warn("unsupported format"), i
        }
        get_data(e) {
            var t = null;
            return "node_array" == e ? t = u.node_array.get_data(this.jm.mind) : "node_tree" == e ? t = u.node_tree.get_data(this.jm.mind) : "freemind" == e ? t = u.freemind.get_data(this.jm.mind) : "text" == e ? t = u.text.get_data(this.jm.mind) : a.error("unsupported " + e + " format"), t
        }
    }
    class v {
        constructor(e, t) {
        ...
        reset() {
            a.debug("layout.reset"), this.bounds = {
                n: 0,
                s: 0,
                w: 0,
                e: 0
        ...
        layout() {
            a.debug("layout.layout"), this.layout_direction(), this.layout_offset()
        }
        layout_direction() {
        ...
        _layout_direction_root() {
            ...
            if (t.direction = i.center, t.side_index = 0, this.isside)
                ...
                s = o;
                for (var a = null; s--;)(a = n[s]).direction == i.left ? this._layout_direction_side(a, i.left, s) : this._layout_direction_side(a, i.right, s)
            }
        }
        ...
        layout_offset() {
            ...
            for (var n = e.children, o = n.length, s = [], a = [], r = null; o--;)(r = n[o])._data.layout.direction == i.right ? a.unshift(r) : s.unshift(r);
        ...
        _layout_offset_subnodes_height(e) {
            for (var t = 0, i = e.length, n = i, o = null, s = 0, a = null, r = 0, d = null; n--;) a = (o = e[n])._data.layout, null == d && (d = o.parent._data), s = this._layout_offset_subnodes_height(o.children), o.expanded || (s = 0), s = Math.max(o._data.view.height, s), o.children.length > 1 && (s += this.opts.cousin_space), a.outer_height = s, a.offset_y = r - s / 2, r = r - s - this.opts.vspace, t += s;
            i > 1 && (t += this.opts.vspace * (i - 1)), n = i;
            for (var l = t / 2; n--;)(o = e[n])._data.layout.offset_y += l;
            return t
        }
        ...
        expand_to_depth(e, t, i) {
            if (!(e < 1))
                for (var n = t || this.jm.mind.root.children, o = i || 1, s = n.length, a = null; s--;) a = n[s], o < e && (a.expanded || this.expand_node(a), this.expand_to_depth(e, a.children, o + 1)), o == e && a.expanded && this.collapse_node(a)
        }
        part_layout(e) {
            ...
            } else a.warn("can not found root node")
        }
        set_visible(e, t) {
    ...
    class p {
        ...
        draw_line(e, t, i, n) {
            var o = p.c("path");
            o.setAttribute("stroke", n || this.opts.line_color), o.setAttribute("stroke-width", this.opts.line_width), o.setAttribute("fill", "transparent"), this.lines.push(o), this.e_svg.appendChild(o), this._bezier_to(o, t.x + i.x, t.y + i.y, e.x + i.x, e.y + i.y)
        }
        copy_to(e, t) {
            var i = new Image;
            i.onload = function () {
    ...
    class f {
        ...
        draw_line(e, t, i, n) {
            ...
            o.strokeStyle = n || this.opts.line_color, o.lineWidth = this.opts.line_width, o.lineCap = "round", this._bezier_to(o, t.x + i.x, t.y + i.y, e.x + i.x, e.y + i.y)
        }
        copy_to(e, t) {
    ...
    class g {
        constructor(e, t) {
            this.opts = t, this.jm = e, this.layout = e.layout, this.container = null, this.e_panel = null, this.e_nodes = null, this.size = {
                w: 0,
                h: 0
            }, this.selected_node = null, this.editing_node = null, this.graph = null, this._initialized = !1
        }
        init() {
            if (a.debug("view.init"), this.container = r.i(this.opts.container) ? this.opts.container : r.g(this.opts.container), this.container) {
                var e;
                this.graph = (e = this, "svg" === this.opts.engine.toLowerCase() ? new p(e) : new f(e)), this.e_panel = r.c("div"), this.e_nodes = r.c("jmnodes"), this.e_editor = r.c("input"), this.e_panel.className = "jsmind-inner jmnode-overflow-" + this.opts.node_overflow, this.e_panel.tabIndex = 1, this.e_panel.appendChild(this.graph.element()), this.e_panel.appendChild(this.e_nodes), this.e_editor.className = "jsmind-editor", this.e_editor.type = "text", this.actualZoom = 1, this.zoomStep = .1, this.minZoom = .5, this.maxZoom = 2;
                var t = this;
            ...
            } else a.error("the options.view.container was not be found in dom")
        }
        add_event(e, t, i) {
        ...
        reset() {
            a.debug("view.reset"), this.selected_node = null, this.clear_lines(), this.clear_nodes(), this.reset_theme()
        }
        reset_theme() {
        ...
        load() {
            a.debug("view.load"), this.setup_canvas_draggable(this.opts.draggable), this.init_nodes(), this._initialized = !0
        }
        expand_size() {
        ...
        create_node_element(e, t) {
            ...
            e.topic && (this.opts.support_html ? r.h(n, e.topic) : r.t(n, e.topic)), n.setAttribute("nodeid", e.id), n.style.visibility = "hidden", this._reset_node_custom_style(n, e.data), t.appendChild(n), i.element = n
        }
        remove_node(e) {
        ...
        update_node(e) {
            var t = e._data.view,
                i = t.element;
            if (e.topic && (this.opts.support_html ? r.h(i, e.topic) : r.t(i, e.topic)), this.layout.is_visible(e)) t.width = i.clientWidth, t.height = i.clientHeight;
            else {
        ...
        edit_node_begin(e) {
            ...
            } else a.warn("don't edit image nodes")
        }
        edit_node_end() {
            if (null != this.editing_node) {
                ...
                t.style.zIndex = "auto", t.removeChild(this.e_editor), d.text.is_empty(i) || e.topic === i ? this.opts.support_html ? r.h(t, e.topic) : r.t(t, e.topic) : this.jm.update_node(e.id, i)
            }
            this.e_panel.focus()
        }
        get_view_offset() {
        ...
        setZoom(e) {
            ...
            this.actualZoom = e;
            for (var t = 0; t < this.e_panel.children.length; t++) this.e_panel.children[t].style.zoom = e;
        ...
        show(e) {
            a.debug("view.show"), this.expand_size(), this._show(), e && this._center_root()
        }
        relayout() {
        ...
        show_lines() {
            ...
            for (var a in e)(t = e[a]).isroot || "visible" in t._data.layout && !t._data.layout.visible || (i = this.layout.get_node_point_in(t), n = this.layout.get_node_point_out(t.parent), o = t.data["leading-line-color"], this.graph.draw_line(n, i, s, o))
        }
    ...
    function y(e) {
        if (!e instanceof x) throw new Error("plugin " + e + " is not a supported plugin");
        w.plugins.push(e)
    }
    ...
    function b(e) {
        r.w.setTimeout((function () {
            ! function (e) {
                for (var t = w.plugins.length, i = null, n = 0; n < t; n++) "function" == typeof (i = w.plugins[n].init) && i(e)
            }(e)
        }), 0)
    }
    class x {
    ...
    class j {
        ...
        static util = d;
        constructor(t) {
            j.current = this, this.options = function (e) {
                var t = {};
                if (d.json.merge(t, l), d.json.merge(t, e), !t.container) throw new Error("the options.container should not be null or empty.");
                return t
            }(t), a.level(o[this.options.log_level]), this.version = e, this.initialized = !1, this.mind = null, this.event_handles = [], this.init()
        }
        init() {
            if (!this.initialized) {
                this.initialized = !0;
                ...
                this.data = new c(this), this.layout = new v(this, e), this.view = new g(this, t), this.shortcut = new m(this, this.options.shortcut), this.data.init(), this.layout.init(), this.view.init(), this.shortcut.init(), this._event_bind(), b(this)
            }
        }
        get_editable() {
        ...
        begin_edit(e) {
            if (!h.is_node(e)) {
                var t = this.get_node(e);
                return t ? this.begin_edit(t) : (a.error("the node[id=" + e + "] can not be found."), !1)
            }
        ...
        _show(e) {
            ...
            this.mind = this.data.load(t), this.mind ? (a.debug("data.load ok"), this.view.load(), a.debug("view.load ok"), this.layout.layout(), a.debug("layout.layout ok"), this.view.show(!0), a.debug("view.show ok"), this.invoke_event_handle(n.show, {
                data: [e]
        ...
        add_node(e, t, o, s, r) {
            ...
            return a.error("fail, this mind map is not editable"), null
        }
        ...
        remove_node(e) {
            if (!h.is_node(e)) {
                var t = this.get_node(e);
                return t ? this.remove_node(t) : (a.error("the node[id=" + e + "] can not be found."), !1)
            }
            if (this.get_editable()) {
                if (e.isroot) return a.error("fail, can not remove root node"), !1;
                var i = e.id,
            ...
            return a.error("fail, this mind map is not editable"), !1
        }
        update_node(e, t) {
            if (this.get_editable())
                if (d.text.is_empty(t)) a.warn("fail, topic can not be empty");
                else {
                    var i = this.get_node(e);
                    if (i) {
                        if (i.topic === t) return a.info("nothing changed"), void this.view.update_node(i);
            ...
            else a.error("fail, this mind map is not editable")
        }
        move_node(e, t, i, o) {
            if (this.get_editable()) {
                var s = this.get_node(e),
                    r = this.mind.move_node(s, t, i, o);
                r && (this.view.update_node(r), this.layout.layout(), this.view.show(!1), this.invoke_event_handle(n.edit, {
                    evt: "move_node",
                    data: [e, t, i, o],
                    node: e
                }))
        ...
        find_node_before(e) {
            ...
            var i = null;
            if (e.parent.isroot)
                for (var n = e.parent.children, o = null, s = null, r = 0; r < n.length; r++) s = n[r], e.direction === s.direction && (e.id === s.id && (i = o), o = s);
        ...
        find_node_after(e) {
            ...
            if (e.parent.isroot) {
                for (var n = e.parent.children, o = !1, s = null, r = 0; r < n.length; r++)
                    if (s = n[r], e.direction === s.direction) {
                        if (o) {
                            i = s;
                            break
                        }
        ...
        set_node_color(e, t, i) {
            if (!this.get_editable()) return a.error("fail, this mind map is not editable"), null;
        ...
        set_node_background_rotation(e, t) {
            ...
            if (i) {
                if (!i.data["background-image"]) return a.error("fail, only can change rotation angle of node with background image"), null;
        ...
        static show(e, t) {
            a.warn("`jsMind.show(options, mind)` is deprecated, please use `jm = new jsMind(options); jm.show(mind);` instead");
            var i = new j(e);
            return i.show(t), i
        }
    }
